        ...
        <div class="col-8 offset-2 my-4 bg-white">
            ...
            <div class="container">
                <div class="border rounded my-2 bg-light">
                    <div class="row">
                        <div class="col-3 offset-1 my-2"><img class="img-fluid img-thumbnail" width="200" height="200" src="//2.bp.blogspot.com/-63vQtYUKJBY/UgSMCmG66LI/AAAAAAAAW6w/-VMth7DVjcY/s400/food_hamburger.png"></div>
                        <div class="h2 col-7"><p class="title mt-2 width-100" href='/posts/{{ $post->id }}'>{{ $post->title }}</p></div>
                    </div>
                    <div class="row">
                ...
                <div class="footer">
                    <div class="text-right"><button type="submit">参加する</button></div>
