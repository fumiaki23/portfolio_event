                ...
                <div class="border rounded my-2 bg-light ">
                    <div class="row">
                        ...
                        <div class="h2 col-7 mt-2">
                            <a class="title width-100" href='/posts/{{ $post->id }}/edit'>{{ $post->title }}</a>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-11 offset-1">
                                <div class="countDown">
                                    <span class="countDownText font-weight-bold">
                                        <script>
                                            var now = new Date();
                                            var point = new Date("{{ $post->date }}");
                                            var countdown = Math.ceil((point.getTime() - now.getTime()) / (1000 * 60 * 60 * 24));
                                            if (countdown >= 0) {
                                                document.write("掲載終了まであと" + countdown + "日");
                                            } else {
                                                document.write("掲載終了しました")
                                            }
                                        </script>
                                    </span>
                                </div>                        
